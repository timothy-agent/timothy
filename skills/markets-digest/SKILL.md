...
| Excuse | Rebuttal |
|---|---|
| "Saying it looks cheap isn't really advice" | Valuation language is advice in a costume; describe, don't evaluate. |
| "The cause of the move is obvious" | Post-hoc narratives are guesses; attribute them to who made them. |
...
- A dramatic move is explained with confidence and zero attribution.
- Any quote lacks a timestamp.
