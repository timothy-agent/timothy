...
-- never a secret value; credential_ref is unused by every kind (a
-- channel destination's credentials live on its channels row, github's
-- token comes from its connector).
